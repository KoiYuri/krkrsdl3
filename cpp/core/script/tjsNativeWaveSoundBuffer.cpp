...
class tTVPWaveSoundBufferDecodePool
{
    ...
    std::vector<tTJSNI_WaveSoundBuffer*> _buffers;
...
public:
    static tTVPWaveSoundBufferDecodePool& Instance()
    {
        static tTVPWaveSoundBufferDecodePool pool;
        return pool;
    }

    void AddBuffer(tTJSNI_WaveSoundBuffer* buf)
    {
        tTJSCriticalSectionHolder holder(_cs);
        _buffers.push_back(buf);
    }

    void RemoveBuffer(tTJSNI_WaveSoundBuffer* buf)
    {
...
private:
    void WorkerLoop()
    {
        tTJSNI_WaveSoundBuffer* target = nullptr;
        do {
            tTJSCriticalSectionHolder holder(_cs);
...
tTJSNI_WaveSoundBuffer::tTJSNI_WaveSoundBuffer()
{
    ...
    tTVPWaveSoundBufferDecodePool::Instance().AddBuffer(this);
...
void tTJSNI_WaveSoundBuffer::Invalidate()
{
    ...
    tTVPWaveSoundBufferDecodePool::Instance().RemoveBuffer(this);
...
void tTJSNI_WaveSoundBuffer::Clear()
{
    ...
    Stop();
    ThreadCallbackEnabled = false;
    DecodeActive.store(false, std::memory_order_release);
    if (LoopManager)
...
void tTJSNI_WaveSoundBuffer::StartPlay()
{
    ...
    DecodeActive.store(true, std::memory_order_release);
    tTVPWaveSoundBufferDecodePool::Instance().Wake();
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void tTJSNI_WaveSoundBuffer::SetPos(tTVReal x, tTVReal y, tTVReal z)
{
    PosX = x;
    PosY = y;
    PosZ = z;
...
//---------------------------------------------------------------------------
void tTJSNI_WaveSoundBuffer::SetPosX(tTVReal v)
{
    PosX = v;
    Set3DPositionToBuffer();
}
//---------------------------------------------------------------------------
void tTJSNI_WaveSoundBuffer::SetPosY(tTVReal v)
{
    PosY = v;
    Set3DPositionToBuffer();
}
//---------------------------------------------------------------------------
void tTJSNI_WaveSoundBuffer::SetPosZ(tTVReal v)
{
    PosZ = v;
    Set3DPositionToBuffer();
}
...
TJS_BEGIN_NATIVE_METHOD_DECL(/*func. name*/ setPos) // not setPosition
{
    ...
    _this->SetPos(static_cast<tTVReal>(x), static_cast<tTVReal>(y), static_cast<tTVReal>(z));
...
TJS_BEGIN_NATIVE_PROP_SETTER
{
    ...
    _this->SetPosX(static_cast<tTVReal>((tTVReal)*param));
...
TJS_BEGIN_NATIVE_PROP_SETTER
{
    ...
    _this->SetPosY(static_cast<tTVReal>((tTVReal)*param));
...
TJS_BEGIN_NATIVE_PROP_SETTER
{
    ...
    _this->SetPosZ(static_cast<tTVReal>((tTVReal)*param));
