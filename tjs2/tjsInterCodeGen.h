...
private:
    ...
    struct tFixData
    {
        ...
        tFixData(
            tjs_int startip, tjs_int size, tjs_int newsize, tjs_int32* code, bool beforeinsertion)
        {
...
private:
    ...
    tjs_int _GenNodeCode(tjs_int& frame,
                         tTJSExprNode* node,
                         tjs_uint32 restype,
                         tjs_int reqresaddr,
                         const tSubParam& param);
    tjs_int GenNodeCode(tjs_int& frame,
                        tTJSExprNode* node,
                        tjs_uint32 restype,
                        tjs_int reqresaddr,
                        const tSubParam& param);
...
#define TJS_GNC_CFLAG_I (TJS_GNC_CFLAG + 1)            // inverted logic
    ...
    static void _output_func(const tjs_char* msg,
                             const tjs_char* comment,
                             tjs_int addr,
                             const tjs_int32* codestart,
                             tjs_int size,
                             void* data);
    static void _output_func_src(const tjs_char* msg,
                                 const tjs_char* name,
                                 tjs_int line,
                                 void* data);
...
public:
    ...
    tTJSExprNode* MakeNP3(tjs_int opecode,
                          tTJSExprNode* node1,
                          tTJSExprNode* node2,
                          tTJSExprNode* node3);
    ...
    void Disassemble(void (*output_func)(const tjs_char* msg,
                                         const tjs_char* comment,
                                         tjs_int addr,
                                         const tjs_int32* codestart,
                                         tjs_int size,
                                         void* data),
                     void (*output_func_src)(
                         const tjs_char* msg, const tjs_char* name, tjs_int line, void* data),
                     void* data,
                     tjs_int start = 0,
                     tjs_int end = 0);
    void Disassemble(void (*output_func)(const tjs_char* msg, void* data),
                     void* data,
                     tjs_int start = 0,
                     tjs_int end = 0);
...
private:
    ...
    void ExecuteAsFunction(iTJSDispatch2* objthis,
                           ...
                           tjs_int start_ip);
    tjs_int ExecuteCode(
        tTJSVariant* ra, tjs_int startip, tTJSVariant** args, tjs_int numargs, tTJSVariant* result);
    tjs_int ExecuteCodeInTryBlock(tTJSVariant* ra,
                                  tjs_int startip,
                                  tTJSVariant** args,
                                  tjs_int numargs,
                                  tTJSVariant* result,
    ...
    tjs_int CallFunction(tTJSVariant* ra,
                         const tjs_int32* code,
                         tTJSVariant** args,
                         tjs_int numargs);
    tjs_int CallFunctionDirect(tTJSVariant* ra,
                               const tjs_int32* code,
                               tTJSVariant** args,
                               tjs_int numargs);
    tjs_int CallFunctionIndirect(tTJSVariant* ra,
                                 const tjs_int32* code,
                                 tTJSVariant** args,
                                 tjs_int numargs);
    static void AddClassInstanceInfo(tTJSVariant* ra, const tjs_int32* code);
    void ProcessStringFunction(const tjs_char* member,
                               const ttstr& target,
                               tTJSVariant** args,
                               tjs_int numargs,
                               tTJSVariant* result);
...
public:
    ...
    tTJSInterCodeContext(tTJSScriptBlock* block,
                         const tjs_char* name,
                         tTJSContextType type,
                         tjs_int32* code,
                         tjs_int codeSize,
    ...
    std::vector<tjs_uint8>* ExportByteCode(bool outputdebug,
                                           tTJSScriptBlock* block,
