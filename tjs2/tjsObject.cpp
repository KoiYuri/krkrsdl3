...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::FuncCallByNum(tjs_uint32 flag,
                                      tjs_int num,
                                      tTJSVariant* result,
                                      tjs_int numparams,
                                      tTJSVariant** param,
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::PropGetByNum(tjs_uint32 flag,
                                     tjs_int num,
                                     tTJSVariant* result,
                                     iTJSDispatch2* objthis)
{
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::PropSetByNum(tjs_uint32 flag,
                                     tjs_int num,
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::GetCountByNum(tjs_int* result, tjs_int num, iTJSDispatch2* objthis)
{
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::DeleteMemberByNum(tjs_uint32 flag, tjs_int num, iTJSDispatch2* objthis)
{
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::InvalidateByNum(tjs_uint32 flag, tjs_int num, iTJSDispatch2* objthis)
{
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::IsValidByNum(tjs_uint32 flag, tjs_int num, iTJSDispatch2* objthis)
{
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::CreateNewByNum(tjs_uint32 flag,
                                       tjs_int num,
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::IsInstanceOfByNum(tjs_uint32 flag,
                                          tjs_int num,
...
//---------------------------------------------------------------------------
tjs_error tTJSDispatch::OperationByNum(tjs_uint32 flag,
                                       tjs_int num,
                                       tTJSVariant* result,
                                       const tTJSVariant* param,
                                       iTJSDispatch2* objthis)
...
void tTJSCustomObject::Finalize(void)
{
    ...
    if (CallFinalize)
    {
        FuncCall(0, finalize_name.c_str(), finalize_name.GetHint(), NULL, 0, NULL, this);
    }
...
bool tTJSCustomObject::CallGetMissing(const tjs_char* name, tTJSVariant& result)
{
    ...
    try
    {
        ...
        try
        {
            ...
            tjs_error er = FuncCall(0, missing_name.c_str(), missing_name.GetHint(), &funcresult, 3,
                                    pargs, this);
            if (TJS_FAILED(er))
            {
                res = false;
...
//---------------------------------------------------------------------------
tTJSCustomObject::tTJSSymbolData* tTJSCustomObject::Add(const tjs_char* name, tjs_uint32* hint)
{
...
//---------------------------------------------------------------------------
tTJSCustomObject::tTJSSymbolData* tTJSCustomObject::Find(const tjs_char* name, tjs_uint32* hint)
{
...
//---------------------------------------------------------------------------
bool tTJSCustomObject::CallEnumCallbackForData(tjs_uint32 flags,
                                               tTJSVariant** params,
                                               ...
                                               const tTJSCustomObject::tTJSSymbolData* data)
{
    ...
    *params[1] = (tjs_int)newflags;
    ...
    if (!(flags & TJS_ENUM_NO_VALUE))
    {
        // get value
        if (TJS_FAILED(
                TJSDefaultPropGet(flags, *(tTJSVariant*)(&(data->Value)), params[2], objthis)))
            return false;
    }

    tTJSVariant res;
    if (TJS_FAILED(callback.FuncCall(0, NULL, NULL, &res, (flags & TJS_ENUM_NO_VALUE) ? 2 : 3,
                                     params, NULL)))
        return false;
                                   ...
                                   iTJSDispatch2* objthis)
{
    ...
    try
    {
        er = tvclosure.Object->PropGet(0, NULL, NULL, &tmp, TJS_SELECT_OBJTHIS(tvclosure, objthis));
    }
    catch (...)
    {
        tvclosure.Release();
    ...
    if (TJS_SUCCEEDED(er))
    {
        ...
        er = tvclosure.Object->FuncCall(flag, NULL, NULL, result, numparams, param,
...
//---------------------------------------------------------------------------
tjs_error TJSDefaultFuncCall(tjs_uint32 flag,
                             tTJSVariant& targ,
                             tTJSVariant* result,
                             tjs_int numparams,
                             tTJSVariant** param,
    ...
    if (targ.Type() == tvtObject)
    {
        ...
        try
        {
            if (tvclosure.Object)
            {
                ...
                {
                    // retry using PropGet
                    er = TJSTryFuncCallViaPropGet(tvclosure, flag, result, numparams, param,
                                                  objthis);
                }
            }
        }
...
//---------------------------------------------------------------------------
tjs_error TJSDefaultPropGet(tjs_uint32 flag,
                            tTJSVariant& targ,
                            tTJSVariant* result,
                            iTJSDispatch2* objthis)
{
    if (!(flag & TJS_IGNOREPROP))
    {
        ...
        if (targ.Type() == tvtObject)
        {
            ...
            if (TJS_SUCCEEDED(hr))
                return hr;
            if (hr != TJS_E_NOTIMPL && hr != TJS_E_INVALIDTYPE && hr != TJS_E_INVALIDOBJECT)
                return hr;
        }
    }
...
//---------------------------------------------------------------------------
tjs_error TJSDefaultPropSet(tjs_uint32 flag,
                            tTJSVariant& targ,
                            const tTJSVariant* param,
                            iTJSDispatch2* objthis)
{
                                    ...
                                    iTJSDispatch2* objthis)
{
    ...
    if (!(flag & TJS_IGNOREPROP))
    {
        ...
        {
            tTJSVariantClosure tvclosure = GetValue(data).AsObjectClosureNoAddRef();
            if (tvclosure.Object)
            {
...
//---------------------------------------------------------------------------
tjs_error TJSDefaultCreateNew(tjs_uint32 flag,
                              tTJSVariant& targ,
                              iTJSDispatch2** result,
                              tjs_int numparams,
                              tTJSVariant** param,
                              iTJSDispatch2* objthis)
{
    if (targ.Type() == tvtObject)
    {
        ...
        {
            // bypass
            return tvclosure.Object->CreateNew(flag, NULL, NULL, result, numparams, param,
                                               TJS_SELECT_OBJTHIS(tvclosure, objthis));
        }
    }
...
//---------------------------------------------------------------------------
tjs_error tTJSCustomObject::CreateNew(tjs_uint32 flag,
                                      const tjs_char* membername,
                                      tjs_uint32* hint,
                                      iTJSDispatch2** result,
                                      tjs_int numparams,
...
*/
//---------------------------------------------------------------------------
tjs_error TJSDefaultIsInstanceOf(tjs_uint32 flag,
                                 tTJSVariant& targ,
                                 const tjs_char* name,
                                 iTJSDispatch2* objthis)
{
    ...
    if (!TJS_strcmp(name, TJS_N("Object")))
        return TJS_S_TRUE;
    ...
    switch (vt)
    {
        ...
        case tvtInteger:
        case tvtReal:
            if (!TJS_strcmp(name, TJS_N("Number")))
                return TJS_S_TRUE;
            return TJS_S_FALSE;
        case tvtString:
            if (!TJS_strcmp(name, TJS_N("String")))
                return TJS_S_TRUE;
            return TJS_S_FALSE;
        case tvtOctet:
            if (!TJS_strcmp(name, TJS_N("Octet")))
                return TJS_S_TRUE;
            return TJS_S_FALSE;
        case tvtObject:
            if (vt == tvtObject)
...
//---------------------------------------------------------------------------
tjs_error TJSDefaultOperation(tjs_uint32 flag,
                              tTJSVariant& targ,
                              tTJSVariant* result,
                              const tTJSVariant* param,
                              iTJSDispatch2* objthis)
{
    ...
    if (targ.Type() == tvtObject)
    {
        ...
        if (tvclosure.Object)
        {
            ...
            else if (hr != TJS_E_NOTIMPL && hr != TJS_E_INVALIDTYPE && hr != TJS_E_INVALIDOBJECT)
            {
                return hr;
            }
...
//---------------------------------------------------------------------------
tjs_error tTJSCustomObject::ClassInstanceInfo(tjs_uint32 flag, tjs_uint num, tTJSVariant* value)
{
    switch (flag)
    {
        case TJS_CII_ADD:
