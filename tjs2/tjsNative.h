...
{
public:
    virtual tjs_error Construct(tjs_int numparams, tTJSVariant** param, iTJSDispatch2* tjs_obj)
    {
        return TJS_S_OK;
    }
...
/*]*/
extern tTJSNativeClassMethod* TJSCreateNativeClassMethod(tTJSNativeClassMethodCallback callback);
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
extern tTJSNativeClassMethod* TJSCreateNativeClassConstructor(
...
//---------------------------------------------------------------------------
typedef tjs_error (*tTJSNativeClassPropertyGetCallback)(tTJSVariant* result,
                                                        iTJSDispatch2* objthis);
...
/*]*/
extern tTJSNativeClassProperty* TJSCreateNativeClassProperty(
    tTJSNativeClassPropertyGetCallback get, tTJSNativeClassPropertySetCallback set);
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
inline extern void TJSNativeClassRegisterNCM(tTJSNativeClass* cls,
                                             const tjs_char* name,
                                             iTJSDispatch2* dsp,
                                             const tjs_char* classname,
                                             tTJSNativeInstanceType type,
...
//---------------------------------------------------------------------------
inline extern void TJSNativeClassSetClassID(tTJSNativeClass* cls, tjs_int32 classid)
{
...
#define TJS_GET_NATIVE_INSTANCE(varname, typename) \
    ...
    { \
        tjs_error hr; \
        hr = objthis->NativeInstanceSupport(TJS_NIS_GETINSTANCE, TJS_NATIVE_CLASSID_NAME, \
...
#define TJS_GET_NATIVE_INSTANCE_OUTER(classname, varname, typename) \
    ...
    { \
        tjs_error hr; \
        hr = objthis->NativeInstanceSupport(TJS_NIS_GETINSTANCE, classname::ClassID, \
                                            (iTJSNativeInstance**)&varname); \
        if (TJS_FAILED(hr)) \
            return TJS_E_NATIVECLASSCRASH; \
    }
...
#define TJS_BEGIN_NATIVE_MEMBERS(classname) \
    { \
        ...
        static tjs_int32 TJS_NCM_CLASSID = TJSRegisterNativeClass(__classname); \
...
#define TJS_BEGIN_NATIVE_METHOD_DECL(name) \
    struct NCM_##name \
    { \
        static tjs_error Process(tTJSVariant* result, \
                                 tjs_int numparams, \
                                 tTJSVariant** param, \
                                 iTJSDispatch2* objthis) \
        {
...
#define TJS_END_NATIVE_METHOD_DECL(name) \
    ...
    TJSNativeClassRegisterNCM(TJS_NCM_REG_THIS, TJS_N(#name), \
                              TJSCreateNativeClassMethod(NCM_##name::Process), __classname, \
                              nitMethod);
